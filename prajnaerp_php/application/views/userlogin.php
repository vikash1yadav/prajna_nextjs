...
?>
                                        ...
                                        <p class="d-flex" style="display:flex; justify-content: space-between; "><a href="<?php echo site_url('site/ufpassword') ?>" class="forgot"> <i class="fa fa-key"></i> <?php echo $this->lang->line('forgot_password'); ?></a> 
                                        <a href="<?php echo site_url('site/login') ?>" class="forgot ml-3"> <i class="fa fa-user"></i> <?php echo $this->lang->line('admin_login'); ?></a> 
                                        </p> 
